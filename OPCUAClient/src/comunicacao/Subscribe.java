...
public class Subscribe {
    ...
    public static final NodeId LED_STATE = new NodeId(4, "|var|CODESYS Control Win V3 x64.Application.GVL.a1");
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final CompletableFuture<OpcUaClient> future = Connect.connect().thenCompose(client -> {
